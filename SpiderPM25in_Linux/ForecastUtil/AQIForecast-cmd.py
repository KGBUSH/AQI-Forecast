...
if __name__ == '__main__':
    ...
    print userLoc,userTime
    print type(userLoc), type(userTime)
    print chardet.detect(userLoc)['encoding']
    #userLoc = userLoc.decode(chardet.detect(userLoc)['encoding'], 'ignore').encode('utf-8')
    #print type(userLoc), userLoc
   # print '\n'


    # a = AQIForecast(location=userLoc, time=userTime)
    # a.forecast()